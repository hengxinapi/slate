...
```json
{
  ...
  "data": {
    ...
    "address": "HXxxx" // 在生成Transaction时使用
  }
}
```
  ...
  "data": [
    {
      ...
      "opponent_id": "c95a14b8-14fe-3228-aa2b-a28c88bd1591", // optional，指向transaction的对方。若用户为接收方则指向发起方，若用户为发起方则指向接收方。只有opponent私钥托管在Hengxin Wallet时，此字段才会有数值。
      "memo": "{}",
